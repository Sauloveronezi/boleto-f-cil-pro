...
export const LABELS_TIPO_LINHA: Record<TipoRegistroCNAB, string> = {
  ...
  detalhe_segmento_s: 'Detalhe Segmento S',
  detalhe_segmento_t: 'Detalhe Segmento T',
  detalhe_segmento_u: 'Detalhe Segmento U',
  detalhe_segmento_a: 'Detalhe Segmento A',
  detalhe_segmento_b: 'Detalhe Segmento B',
  detalhe_segmento_y: 'Detalhe Segmento Y',
  detalhe_segmento_y03: 'Detalhe Segmento Y03',
  detalhe_segmento_y04: 'Detalhe Segmento Y04',
  detalhe_segmento_y53: 'Detalhe Segmento Y53',
...
export const CORES_TIPO_LINHA: Record<TipoRegistroCNAB, string> = {
  ...
  detalhe_segmento_s: 'border-l-sky-500',
  detalhe_segmento_t: 'border-l-rose-500',
  detalhe_segmento_u: 'border-l-fuchsia-500',
  detalhe_segmento_a: 'border-l-amber-500',
  detalhe_segmento_b: 'border-l-orange-500',
  detalhe_segmento_y: 'border-l-yellow-500',
  detalhe_segmento_y03: 'border-l-yellow-400',
  detalhe_segmento_y04: 'border-l-yellow-600',
  detalhe_segmento_y53: 'border-l-yellow-300',
...
export function gerarCamposDetalheR240(): CampoCNABCompleto[] {
  return [
    ...
    { id: gerarIdCampo(), nome: 'CNAB', posicaoInicio: 15, posicaoFim: 15, tipo: 'alfanumerico', tamanho: 1, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Uso FEBRABAN', cor: CORES_CAMPOS[5] },
    { id: gerarIdCampo(), nome: 'Código de Ocorrência', posicaoInicio: 16, posicaoFim: 17, tipo: 'numerico', tamanho: 2, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Identificação da ocorrência', campoDestino: 'codigo_ocorrencia', cor: CORES_CAMPOS[6] },
    { id: gerarIdCampo(), nome: 'Zeros', posicaoInicio: 18, posicaoFim: 18, tipo: 'numerico', tamanho: 1, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[7] },
    { id: gerarIdCampo(), nome: 'Data 2º Desconto', posicaoInicio: 19, posicaoFim: 26, tipo: 'numerico', tamanho: 8, formato: 'data_ddmmaaaa', obrigatorio: false, utilizadoNoBoleto: true, descricao: 'Data do 2º desconto', campoDestino: 'data_desconto_2', cor: CORES_CAMPOS[8] },
    { id: gerarIdCampo(), nome: 'Valor 2º Desconto', posicaoInicio: 27, posicaoFim: 41, tipo: 'numerico', tamanho: 15, formato: 'valor_centavos', obrigatorio: false, utilizadoNoBoleto: true, descricao: 'Valor do 2º desconto', campoDestino: 'valor_desconto_2', cor: CORES_CAMPOS[9] },
    { id: gerarIdCampo(), nome: 'Zeros', posicaoInicio: 42, posicaoFim: 42, tipo: 'numerico', tamanho: 1, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[10] },
    { id: gerarIdCampo(), nome: 'Data 3º Desconto', posicaoInicio: 43, posicaoFim: 50, tipo: 'numerico', tamanho: 8, formato: 'data_ddmmaaaa', obrigatorio: false, utilizadoNoBoleto: true, descricao: 'Data do 3º desconto', campoDestino: 'data_desconto_3', cor: CORES_CAMPOS[11] },
    { id: gerarIdCampo(), nome: 'Valor 3º Desconto', posicaoInicio: 51, posicaoFim: 65, tipo: 'numerico', tamanho: 15, formato: 'valor_centavos', obrigatorio: false, utilizadoNoBoleto: true, descricao: 'Valor do 3º desconto', campoDestino: 'valor_desconto_3', cor: CORES_CAMPOS[12] },
    { id: gerarIdCampo(), nome: 'Código Multa', posicaoInicio: 66, posicaoFim: 66, tipo: 'numerico', tamanho: 1, obrigatorio: false, utilizadoNoBoleto: true, descricao: 'Código da multa', campoDestino: 'codigo_multa', cor: CORES_CAMPOS[0] },
    { id: gerarIdCampo(), nome: 'Data Multa', posicaoInicio: 67, posicaoFim: 74, tipo: 'numerico', tamanho: 8, formato: 'data_ddmmaaaa', obrigatorio: false, utilizadoNoBoleto: true, descricao: 'Data da multa', campoDestino: 'data_multa', cor: CORES_CAMPOS[1] },
    { id: gerarIdCampo(), nome: 'Valor Multa', posicaoInicio: 75, posicaoFim: 89, tipo: 'numerico', tamanho: 15, formato: 'valor_centavos', obrigatorio: false, utilizadoNoBoleto: true, descricao: 'Valor/percentual da multa', campoDestino: 'valor_multa', cor: CORES_CAMPOS[2] },
    { id: gerarIdCampo(), nome: 'Brancos', posicaoInicio: 90, posicaoFim: 99, tipo: 'alfanumerico', tamanho: 10, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[3] },
    { id: gerarIdCampo(), nome: 'Informação ao Pagador', posicaoInicio: 100, posicaoFim: 139, tipo: 'alfanumerico', tamanho: 40, obrigatorio: false, utilizadoNoBoleto: true, descricao: 'Observações ao pagador', campoDestino: 'informacao_pagador', cor: CORES_CAMPOS[4] },
    { id: gerarIdCampo(), nome: 'Brancos', posicaoInicio: 140, posicaoFim: 199, tipo: 'alfanumerico', tamanho: 60, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[5] },
    { id: gerarIdCampo(), nome: 'Código Ocorrência Pagador', posicaoInicio: 200, posicaoFim: 207, tipo: 'numerico', tamanho: 8, obrigatorio: false, utilizadoNoBoleto: true, descricao: 'Código de ocorrência do pagador', campoDestino: 'codigo_ocorrencia_pagador', cor: CORES_CAMPOS[6] },
    { id: gerarIdCampo(), nome: 'Zeros', posicaoInicio: 208, posicaoFim: 215, tipo: 'numerico', tamanho: 8, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[7] },
    { id: gerarIdCampo(), nome: 'Brancos', posicaoInicio: 216, posicaoFim: 216, tipo: 'alfanumerico', tamanho: 1, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[8] },
    { id: gerarIdCampo(), nome: 'Zeros', posicaoInicio: 217, posicaoFim: 228, tipo: 'numerico', tamanho: 12, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[9] },
    { id: gerarIdCampo(), nome: 'Brancos', posicaoInicio: 229, posicaoFim: 231, tipo: 'alfanumerico', tamanho: 3, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[10] },
    { id: gerarIdCampo(), nome: 'Zeros', posicaoInicio: 232, posicaoFim: 232, tipo: 'numerico', tamanho: 1, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[11] },
    { id: gerarIdCampo(), nome: 'Brancos', posicaoInicio: 233, posicaoFim: 240, tipo: 'alfanumerico', tamanho: 8, obrigatorio: false, utilizadoNoBoleto: false, descricao: 'Complemento', cor: CORES_CAMPOS[12] },
  ];
}
