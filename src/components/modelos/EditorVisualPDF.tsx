...
const VARIAVEIS_BOLETO = [
  ...
  { variavel: '{{valor_desconto}}', label: 'Valor Desconto', categoria: 'titulo' },
  { variavel: '{{data_desconto}}', label: 'Data Desconto', categoria: 'titulo' },
  { variavel: '{{numero_cobranca}}', label: 'Número Cobrança', categoria: 'titulo' },
  ...
  { variavel: '{{dyn_conta}}', label: 'Conta (Dinâmica)', categoria: 'outros' },
  { variavel: '{{dyn_zonatransporte}}', label: 'Zona Transporte', categoria: 'outros' },
  { variavel: '{{dyn_nome_do_cliente}}', label: 'Nome Cliente (Dinâmico)', categoria: 'outros' },
  { variavel: '{{dyn_cidade}}', label: 'Cidade (Dinâmica)', categoria: 'outros' },
  { variavel: '{{dyn_desconto1}}', label: 'Desconto 1 (Dinâmico)', categoria: 'outros' },
  { variavel: '{{dyn_desconto_data}}', label: 'Data Desconto (Dinâmico)', categoria: 'outros' },
];
